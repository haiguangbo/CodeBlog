...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.codingblog.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(org.codingblog.domain.Authority.class.getName(), jcacheConfiguration);
